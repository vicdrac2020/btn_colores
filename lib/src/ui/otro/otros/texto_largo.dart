...
class TextoLargo extends StatefulWidget {
  const TextoLargo({ Key? key }) : super(key: key);

  @override
  _TextoLargoState createState() => _TextoLargoState();
}

class _TextoLargoState extends State<TextoLargo> {
  ...
  _addModel(){
    for (var i = 0; i < 50; i++){
      model.add(ItemModel("Otro $i",false));
    }
  }
  @override
